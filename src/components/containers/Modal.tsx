  ...
  return (
    ...
    >
      <div className="flex items-center justify-center min-h-screen">
        ...
        <div className="relative w-full p-6 bg-white border-2 rounded-lg dark:border-indigo-400 sm:w-11/12 md:w-10/12 lg:w-8/12 xl:w-6/12 bg-gray-50 dark:bg-gray-900">
